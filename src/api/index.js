...
export default {
  ...
  insertAuthenticationHospital(param, callbak) {
    return http.postAsFormData(
      `${baseUrl}/hospital/insertAuthenticationHospital.htm`,
      param,
      callbak
    )
  },
  ...
  registerSendValidate(param, callbak) {
    return http.get(`${baseUrl}/hospital/registerSendValidate.json`, param, callbak)
  },
  // 机构验证码登陆 验证手机号,并发送验证码
  loginSendValidate(param, callbak) {
    return http.get(`${baseUrl}/hospital/loginSendValidate.json`, param, callbak)
  },
  // 机构重新认证 点进去调用查看之前认证的信息及拒绝原因
  findHospitalDetail(param, callbak) {
    return http.get(`${baseUrl}/hospital/findHospitalDetail.json`, param, callbak)
  },
  // 机构验证码登陆
  logValidates(param, callbak) {
    return http.get(`${baseUrl}/hospital/logValidates.htm`, param, callbak)
  },
  // 用户验证码第一次设置密码
  updateUserPasswordValidateLogin(param, callbak) {
    return http.get(`${baseUrl}/hospital/updateUserPasswordValidateLogin.htm`, param, callbak)
  },
  // 机构注册用户
  insertUserRegister(param, callbak) {
    return http.get(`${baseUrl}/hospital/insertUserRegister.htm`, param, callbak)
  },
  // 修改密码
  ...
  updateHospital(param, callbak) {
    return http.postAsFormData(`${baseUrl}/hospital/updateHospital.htm`, param, callbak)
  },
  // 修改认证
