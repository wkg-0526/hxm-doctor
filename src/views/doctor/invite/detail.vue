    ...
    <div class="auth-detail-wrapper">
        ...
        >
            ...
            <template slot="title">
                ...
                <span v-if="type === '1'">医生信息</span>
                <span v-if="type === '2' && detailData.status === 0" style="color: #FF8233">邀请中</span>
                <span v-if="type === '2' && detailData.status === 1" style="color: #989898">已同意</span>
                <span v-if="type === '2' && detailData.status === 2" style="color: #989898">已拒绝</span>
            </template>
        </infoLink>   
    </div>
</template>
...
import infoLink from './component/info'
...
export default {
    ...
    methods: {
        getDetailData(){
            let _url = ''
            if(this.type === '1'){
                _url = 'hospitalOperateInvitationDoctorDetail'
            }else{
                _url = 'findAlreadyInvitedDoctorDetail'
            }
            ...
            this.$confirm('是否邀请该医生?', '提示', {
                ...
                this.isDisabled = true;
                    ...
                    .then((res) =>{
                        ...
                        if(res && res.status === 200){
                            console.log(res.data.result,'dd')
