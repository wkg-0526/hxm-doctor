<template>
  <div class="qualification-box">
    <div class="qualification-title">请提交机构的资质证明材料</div>
        ...
        <el-row :gutter="14" style="paddingBottom:20px">
          <el-col :span="12">
            ...
            <el-form-item label="医疗机构执业许可证：">
              <label for="institutionalLicenseFile">
                <div class="img pointer" v-show="!imgUrl2">+</div>
                <el-image
                  style="width: 328px; height: 180px"
                  :src="imgUrl2"
                  v-show="imgUrl2"
          ...
          <el-col :span="12">
            <div class="qualification-tip">
              ...
              <div class="text">1、证件大小不超过2MB</div>
              <div class="text">2、证件需在有效期内</div>
              <div class="text">3、需盖有地方卫生部门公章</div>
              <div class="text">4、证件名称需与认证名称匹配</div>
              <div class="text">5、营业执照名称需与医疗机构执业许可证名称匹配</div>
              <div class="text">6、诊疗科目中需含有：医疗美容科、整形外科、美容皮肤科等医疗美容相关科目</div>
            </div>
          </el-col>
        </el-row>
      </el-form>
    ...
    <div class="form">
      ...
      >
        ...
        <el-form-item label="联系人职位" prop="position">
          <el-select v-model="formData2.position" placeholder="请选择" class="input">
...
export default {
  ...
  data() {
    ...
    return {
      ...
      rules2: {
        ...
        legalPersonPhone: [{ required: true, message: "请输入法人手机", trigger: "blur" }],
        fullName: [{ required: true, message: "请输入联系人名字", trigger: "blur" }],
        telePhone: [{ required: true, message: "请输入联系人手机", trigger: "blur" }],
        mailbox: [{ required: true, message: "请输入电子邮箱", trigger: "blur" }],
        position: [{ required: true, message: "请选择联系人职位", trigger: "change" }]
      },
      disabled: false
    };
  },
  methods: {
    ...
    submitForm: function() {
      ...
      if (_pass1 && _pass2) {
        this.$emit("setData", { qualificationData: { ...this.formData1, ...this.formData2 } }, 3);
      }
    },
    toBack() {
