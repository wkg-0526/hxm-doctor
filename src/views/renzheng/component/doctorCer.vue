      ...
      <el-form ref="form1" :model="formData1" label-width="100px" label-position="left">
        ...
        <el-form-item label="个人介绍">
          <label for="introductionFile">
            <span class="img pointer" v-show="!imgUrl1">+</span>
            <el-image style="width: 220px;" :src="imgUrl1" v-show="imgUrl1" class="pointer"></el-image>

            <input
              id="introductionFile"
              type="file"
              class="el-upload__input"
              @change="fileChange1($event,'introductionFile','imgUrl1')"
            />
          </label>
