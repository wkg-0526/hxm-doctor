<template>
  <div class="material-box">
    <div class="material-tip">请填写下方认证机构所需的资料</div>
    <div class="form">
      <el-form
        ref="form"
        :rules="rules"
      ...
      >
        <el-form-item label="头像" prop="hospitalLogFile">
          <label for="fileInput">
            <el-avatar :size="106" class="avartar pointer" v-show="!imgUrl">点击上传</el-avatar>
            <el-avatar :size="106" :src="imgUrl" fit="contain" v-show="imgUrl" class="pointer"></el-avatar>
            <!-- <span 
        ...
        <el-form-item label="医院名称" prop="hospitalName">
          <el-input v-model="formData.hospitalName" class="input" placeholder="请输入"></el-input>
        </el-form-item>
        ...
        <el-form-item label="国家" prop="country">
          <el-select v-model="formData.country" placeholder="请选择" class="input">
        ...
        <el-form-item label="类型" prop="type">
          <el-select v-model="formData.type" placeholder="请选择" :offset="2" class="input" clearable>
  ...
  data() {
    ...
    return {
      ...
      rules: {
        ...
        country: [{ required: true, message: "请选择成立时间", trigger: "change" }],
        address: [{ required: true, message: "请输入地址", trigger: "blur" }],
        type: [{ required: true, message: "请选择类型", trigger: "change" }],
        introduce: [{ required: false, trigger: "blur" }]
      }
    };
  },
  methods: {
